    ...
    try:
        ...
        def delayed_show():
            ...
            if hasattr(app, 'root') and app.root.winfo_exists():
                ...
                app.root.after(10, app.show_main_window)  # Queue call to show_main_window in the Tkinter event loop
            else:
                logger.error("Cannot show main window - root does not exist or is not valid")
